package www.glaway.baselibrary.view.flipshare;
 ...
 *
 *
 *         FlipShareView share = new FlipShareView.Builder(this, imgTitlePersonsetting)
 *                 .addItem(new ShareItem("个人设置", ColorUtils.string2Int("#666666"), 0xffffffff, BitmapFactory.decodeResource(getResources(), R.mipmap.personsetting_v2)))
 *                 .addItem(new ShareItem("登出", ColorUtils.string2Int("#666666"), 0xffffffff, BitmapFactory.decodeResource(getResources(), R.mipmap.tuichu)))
 *                 .addItem(new ShareItem("关机", ColorUtils.string2Int("#666666"), 0xffffffff, BitmapFactory.decodeResource(getResources(), R.mipmap.guanji)))
 *                 .addItem(new ShareItem("ITEM浏览", ColorUtils.string2Int("#666666"), 0xffffffff, BitmapFactory.decodeResource(getResources(), R.mipmap.itemapp)))
...
public class FlipShareView extends View {
    ...
    public FlipShareView(Context context, Window window, View parentView) {
        ...
        mBgRect = new RectF(0, 53, mScreenWidth, mScreenHeight);
        addView(window);
        initView();
    }
    ...
    public static class Builder {
        ...
        private int mMilliSecond = 0;//设置显示动画时间
